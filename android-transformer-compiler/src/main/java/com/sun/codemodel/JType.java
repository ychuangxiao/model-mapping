 ...
 *
 * A type is always either primitive ({@link com.sun.codemodel.JPrimitiveType}) or
 * a reference type ({@link com.sun.codemodel.JClass}).
 */
public abstract class JType implements JGenerable, Comparable<JType> {
     ...
     *
     * @return A {@link com.sun.codemodel.JClass} representing the array type
