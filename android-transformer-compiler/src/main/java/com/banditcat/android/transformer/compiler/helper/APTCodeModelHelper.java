...
public class APTCodeModelHelper {
	...
	public String toUpperCamelCase(String fielName) {
		return fielName.substring(0, 1).toUpperCase().concat(fielName.substring(1));
	}

	public String toLowerCamelCase(String fielName) {
		return fielName.substring(0, 1).toLowerCase().concat(fielName.substring(1));
	}
